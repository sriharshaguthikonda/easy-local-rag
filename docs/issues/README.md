...
#14 is closed, while #6 remains open and in progress.

## Required execution order

`#2 -> #18 -> early #26 -> #19 -> #20A -> .memory #4 -> #20B -> .memory #5 -> #23 -> #21/#22 -> #27 -> #25 -> future GUI -> late #26`
...
|---|---|---|---|---|---|
| #2 | P0 security | Open — immediate blocker | [Rotate Groq keys](ISSUE-002-rotate-groq-keys.md) | First gate; credential rotation and approved history remediation precede archive/export work. | [Issue #2](https://github.com/sriharshaguthikonda/easy-local-rag/issues/2) |
...
| #6 | P0 bug | **Open — in progress** | [MMR embedding fix](ISSUE-006-mmr-embedding-keyerror.md) | Preserve #11's embedding contract; close only after the functional fake-collection regression passes. | [Issue #6](https://github.com/sriharshaguthikonda/easy-local-rag/issues/6) |
...
| #16 | P1 developer experience | Open — fresh-clone proof needed | [Setup and dependency docs](ISSUE-016-dx-setup-docs.md) | Incorporates #2/#8/#13 contracts; coordinates with early and late #26 without duplicating cleanup. | [Issue #16](https://github.com/sriharshaguthikonda/easy-local-rag/issues/16) |
...
| #18 | P0 security | Open — early preservation gate | [Branch and PR inventory](ISSUE-018-branch-pr-inventory.md) | After #2; before early #26, #19, and any branch/PR deletion. | [Issue #18](https://github.com/sriharshaguthikonda/easy-local-rag/issues/18) |
| #19 | P0 todo | Open — first migration implementation | [Chroma audit and export](ISSUE-019-chroma-audit-export.md) | After #2/#18/early #26; blocks #20A and all destination work. | [Issue #19](https://github.com/sriharshaguthikonda/easy-local-rag/issues/19) |
...
| #24 | P2 enhancement | Open — specification only | [Thin GUI specification](ISSUE-024-thin-gui-spec.md) | Records requirements after stable #21/#22/#23/#27 contracts; implementation is a separate future issue after #25. | [Issue #24](https://github.com/sriharshaguthikonda/easy-local-rag/issues/24) |
...
| #26 | P1 developer experience | Open — split early/late | [Repository cleanup](ISSUE-026-repo-cleanup.md) | Early hygiene follows #2/#18 and precedes #19; late cleanup follows #25 and future GUI. | [Issue #26](https://github.com/sriharshaguthikonda/easy-local-rag/issues/26) |
| #27 | P0 security | Open — answer-safety gate | [Grounded answers](ISSUE-027-grounded-answers.md) | Extends #5/#13/#14; after #21/#22 and before #25. | [Issue #27](https://github.com/sriharshaguthikonda/easy-local-rag/issues/27) |
